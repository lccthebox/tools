...
const storyEn="Rosé has a completely free Sunday after several busy weeks. Three invitations arrive before breakfast. One friend wants a long walk, another suggests a crowded market, and her cousin asks for help moving a table. Rosé wants real rest, but she worries that saying no will disappoint everyone. She makes tea and reads the messages again. She can choose only one plan without feeling rushed. Which invitation should she accept?";
