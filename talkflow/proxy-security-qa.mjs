...
assert.equal(Object.keys(structuredUpstream.output_config.format.schema.properties).length <= 35, true, "upstream uses the shallow transport schema");
assert.equal(simple.assertContentFillSchemaComplexity().properties <= 45, true, "server-owned transport passes the project complexity precheck");
